      ...
      <div className='w-full bg-slate-100'>
        <div className='grid grid-cols-1 sm:grid-cols-2'>
          <div className='bg-white m-4 p-4 rounded-2xl shadow-xl'>
            ...
            <div className='my-3 font-semibold text-center text-xl'>충남삼성고등학교 갤럭시 홀</div>
            <Image src={schoolmap} alt="school map" className='rounded-xl shadow-lg w-3/4 mx-auto'></Image>
          </div>
          <div className='bg-white m-4 p-4 rounded-2xl shadow-xl'>
            <div className='flex justify-center items-center flex-col w-full h-full'>
              <div className='text-2xl font-bold text-center'>일시</div>
              <div className='my-3 font-semibold text-center text-xl'>2022.11.08 (화) ET, EP1, EP2</div>
            </div>
          </div>
        </div>
        ...
        <div className='grid grid-cols-2 lg:grid-cols-4'>
          ...
          <Link href="/poster">
            <div className='bg-blue-900 py-12 hover:bg-blue-800 transition duration-300 m-4 p-4 rounded-2xl shadow-xl'>
              <div className='text-2xl font-bold text-center text-white'>발표 포스터</div>
            </div>
          </Link>
